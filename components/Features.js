    ...
    <section id="features" className="py-12">
      <div className="max-w-xl px-4 py-12 mx-auto sm:px-3 lg:max-w-6xl lg:px-8">
        ...
        <p className="max-w-md mx-auto mb-10 text-lg text-gray-600 dark:text-gray-400 md:text-lg">
          We&apos;re introducing basic features for our exiciting <b>Auto Insurance</b> app.
        </p>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="mb-10 space-y-6">
            <h1 className="text-xl font-bold text-center text-blue-600 dark:text-yellow-400 md:text-2xl sm:text-left">
              Home
            </h1>
